...
public class EngineApi {
     ...
     * 委托 trans
     */
    private static final EventTranslatorOneArg<RbCmd, OrderCmd> NEW_ORDER_TRANSLATOR =
            (rbCmd, seq, newOrder) -> {
     ...
     * 撤单 trans
     */
    private static final EventTranslatorOneArg<RbCmd, OrderCmd> CANCEL_ORDER_TRANSLATOR =
            (rbCmd, seq, cancelOrder) -> {
     ...
     * 行情发送
     */
    private static final EventTranslatorOneArg<RbCmd, OrderCmd> HQ_PUB_TRANSLATOR =
            (rbCmd, seq, hqPub) -> {
